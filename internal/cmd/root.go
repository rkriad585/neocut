...
func init() {
	...
	rootCmd.Flags().IntVarP(&cfg.Bitrate, "bitrate", "b", 0, "Output bitrate in kbps (e.g. 192, 320)")
	rootCmd.Flags().BoolVar(&cfg.DryRun, "dry-run", false, "Preview stats without exporting")
